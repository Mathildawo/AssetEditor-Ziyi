...
namespace Editors.AnimationVisualEditors.CampaignAnimationCreator.DevConfig
{
    internal class CampaignAnimation_Damsel : IDeveloperConfiguration
    {
        ...
        public void OpenFileOnLoad()
        {
            ...
            _editorCreator.Create(EditorEnums.CampaignAnimation_Editor, x => (x as EditorHost<CampaignAnimationCreatorViewModel>).Editor.SetDebugInputParameters(debugInput));
