...
namespace Editors.Shared.Core.Common.ReferenceModel
{
    public class SelectAnimationViewModel : NotifyPropertyChangedImpl
    {
        ...
        public AnimationReference SelectedAnimation
        {
            get => _selectedAnimation;
            set
            {
                SetAndNotify(ref _selectedAnimation, value);
        ...
        public SelectAnimationViewModel(SceneObjectEditor assetViewModelEditor, SceneObject data, IPackFileService pfs, ISkeletonAnimationLookUpHelper skeletonAnimationLookUpHelper)
        {
        ...
        void AnimationChanged(AnimationReference animationReference)
        {
            if (animationReference != null)
                _assetViewModelEditor.SetAnimation(_data, animationReference.AnimationFile);
            else
